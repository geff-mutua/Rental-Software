...
<body
    ...
    <div style="display: none;">We are please to welcome you to Georental</div>
    <div role="article" aria-roledescription="email" aria-label="Welcome to Georental 👋" lang="en">
                                ...
                                <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%"
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p style="font-weight: 600; font-size: 18px; margin-bottom: 0;">Hello there,</p>
                                            <p
                                                style="font-weight: 700; font-size: 20px; margin-top: 0; --text-opacity: 1; color: #0707A4; color: rgba(255, 88, 80, var(--text-opacity));">
                                                </p>
                                            ...
                                            <p style="margin: 24px 0;">
                                                <b>{{$data['transaction_id']}}</b> Payment transaction could not be verified. The account number listed <b>{{$data['bill_ref_number']}}</b> from business shortcode <b>{{$data['business_shortcode']}}</b> could not be authenticated. 
                                            </p>
                                            <p style="font-weight: 500; font-size: 16px; margin-bottom: 0;">Transaction Details is as follows</p>
                                            <ul style="margin-bottom: 24px;">
                                                <li>
                                                    Payment From : {{$data['first_name']}} {{$data['middle_name']}} {{$data['last_name']}}
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    Transaction Amount :  {{number_format($data['transaction_amount'])}}
                                                </li>
                                                <li>
                                            ...
                                            <table style="font-family: 'Montserrat',Arial,sans-serif;" cellpadding="0"
                                                ...
                                                <tr>
                                                    <td style="mso-padding-alt: 16px 24px; --bg-opacity: 1; background-color: #7367f0; background-color: rgba(115, 103, 240, var(--bg-opacity)); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;"
                                                        ...
                                                        <a href="{{url('/')}}"
                                                            style="display: block; font-weight: 600; font-size: 14px; line-height: 100%; padding: 16px 24px; --text-opacity: 1; color: #ffffff; color: rgba(255, 255, 255, var(--text-opacity)); text-decoration: none;">Login to view &rarr;</a>
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <p style="margin: 0 0 16px;">
                                               Login to your account to mannualy map the transaction to the targeted account.
                                               
                                            </p>
                                            <p style="margin: 0 0 16px;">Regards, <br>Georental Support Team</p>
                                        </td>
                                    </tr>
                                    <tr>
